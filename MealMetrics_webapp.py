...
if page == 'Dashboard':
    ...
    series_data_health = [{"value": count, "name": category} for category, count in zip(xAxis_data_health, category_counts_health['Count'])]
    
    # Options for 'Health Consciousness' bar chart
    options_health = {
        "title": {"text": "Health Consciousness Analysis", "subtext": "Distribution of Health Consciousness Responses", "left": "center"},
    ...
    series_data_priorities = [{"value": count, "name": category} for category, count in zip(xAxis_data_priorities, priorities_counts['Count'])]
    
    # Options for 'Food Selection Priorities' bar chart
    options_priorities = {
        "title": {"text": "Food Selection Priorities Analysis", "subtext": "Distribution of Food Selection Priorities", "left": "center"},
        "tooltip": {"trigger": "axis", "axisPointer": {"type": "shadow"}},
        ...
        "children": [
            {
                "name": "Vegetarian",
                "children": [
                    {"name": "Lacto-vegetarian", "children": [{"name": "Dairy products included"}, {"name": "No eggs or meat"}]},
                    {"name": "Ovo-vegetarian", "children": [{"name": "Eggs included"}, {"name": "No dairy or meat"}]},
                    {"name": "Lacto-ovo vegetarian", "children": [{"name": "Includes dairy and eggs"}, {"name": "No meat"}]},
                    {"name": "Flexitarian", "children": [{"name": "Primarily vegetarian"}, {"name": "Occasional meat consumption"}]},
                ],
            },
            {
                "name": "Vegan",
                "children": [
                    {"name": "Raw vegan", "children": [{"name": "Only uncooked foods"}, {"name": "No animal products"}]},
                    {"name": "Whole-food vegan", "children": [{"name": "Whole plant foods"}, {"name": "Minimally processed"}]},
                ],
            },
            {
                "name": "Pescatarian",
                "children": [
                    {"name": "Mediterranean", "children": [{"name": "Fish and seafood"}, {"name": "Plant-based with olive oil"}]},
            ...
            },
            {
                "name": "Ketogenic",
                "children": [
                    {"name": "Standard Ketogenic", "children": [{"name": "High fat"}, {"name": "Low carb"}, {"name": "Moderate protein"}]},
                    {"name": "Targeted Ketogenic", "children": [{"name": "Carbs around workouts"}, {"name": "High fat"}]},
                ],
            },
            {
                "name": "Paleo",
                "children": [
                    ...
                    {"name": "Autoimmune Paleo", "children": [{"name": "Avoids inflammatory foods"}, {"name": "Focus on nutrient density"}]},
                ],
            },
            # Add more diet types and subcategories as needed
            {
                "name": "Fast Food Diet",
                "children": [
                    {"name": "Convenience-focused", "children": [{"name": "Readily available meals"}, {"name": "Includes processed foods"}]},
                    {"name": "Snack-oriented", "children": [{"name": "High in snacks"}, {"name": "Low in whole foods"}]},
                ],
            },
            {
                "name": "Junk Food Diet",
                "children": [
                    {"name": "High Sugar", "children": [{"name": "Soda and candies"}, {"name": "Processed sweet snacks"}]},
            ...
            },
            {
                ...
                "children": [
                    {"name": "Celiac-friendly", "children": [{"name": "Strictly no gluten"}, {"name": "Focus on gluten-free grains"}]},
                    {"name": "Non-Celiac Gluten Sensitivity", "children": [{"name": "Reduced gluten intake"}, {"name": "Emphasis on whole foods"}]},
                ],
            },
            {
                "name": "Low Carb Diet",
                "children": [
                    {"name": "Atkins Diet", "children": [{"name": "Phases of carb intake"}, {"name": "High protein and fat"}]},
                    {"name": "South Beach Diet", "children": [{"name": "Low glycemic index foods"}, {"name": "Phased approach to carbs"}]},
                ],
            },
            {
                "name": "Mediterranean Diet",
                "children": [
                    {"name": "Heart-healthy", "children": [{"name": "Rich in fruits and vegetables"}, {"name": "Includes whole grains and lean proteins"}]},
                    {"name": "Wine-inclusive", "children": [{"name": "Moderate wine consumption"}, {"name": "Balanced diet with healthy fats"}]},
                ],
            },
        ],
    }
